...
An alternative language for Data Science is R. As of 2026, R typically offers more legible, compact and elegant code than python for front-end data science. Also many statistical methods have been natively developped in R with typically better default behaviour. Until 2025, this course used to be taught in R. The script is available at:
