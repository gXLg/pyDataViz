...
(
  ggplot(
    tempdf,
    aes(x="Horsepower", y="Weight", label="label")
  )
  + geom_point()
...
# center (like scale(..., center=TRUE, scale=FALSE))
...
The **biplot** shows the projection of the data on the first two principal components. It includes both the position of each sample in terms of `PC1` and `PC2` and also shows how the initial variables map onto this.
