...
heights["prop"] = heights.groupby("height_bins")["sex"].transform(lambda s: (s == "M").mean())
...
minor_raw = np.tile(np.arange(1.0, 10.0), len(exponents)) * np.repeat(10.0 ** exponents, 9)
...
p_log_odds = (
  ...
  + scale_color_manual(values={False: "#999999", True: "#000000"})
